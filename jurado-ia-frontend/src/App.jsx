  ...
  return (
    <div className="App-wrapper">
      <div className="background-icons">
        <i className="fas fa-gavel"></i><i className="fas fa-file-alt"></i>
        <i className="fas fa-chart-bar"></i><i className="fas fa-balance-scale"></i>
        <i className="fas fa-microchip"></i><i className="fas fa-search"></i>
      </div>
