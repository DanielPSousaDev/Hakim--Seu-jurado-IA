...
function AboutPage() {
  // A lógica de tema foi removida daqui, pois o App.jsx já a controla para todas as páginas.

  return (
    // A estrutura principal (App-wrapper, top-nav) foi removida.
    // A página agora começa diretamente com seu conteúdo principal.
